...
|===
| Field | Description
| *`config`* __xref:{anchor_prefix}-github-com-korrel8r-operator-api-v1alpha1-config[$$Config$$]__ | Config is the configuration for a korrel8r deployment. If not provided there is a default configuration suitable for use in an openshift cluster. +
